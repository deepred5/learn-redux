...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/createStore.js":[function(require,module,exports) {
"use strict";
...
function createStore(reducer, preloadedState) {
  ...
  function subscribe(listener) {
    currentListeners.push(listener); // 取消订阅
...
},{"./createStore":"src/createStore.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
function app() {
  ...
  switch (action.type) {
    ...
    case HOBBY:
      return _objectSpread({}, state, {
        hobby: [].concat(_toConsumableArray(state.hobby), [action.hobby])
      });
...
var store = (0, _index.createStore)(app);
var a = store.subscribe(function () {
  console.log('subscribe1'); // console.log(store.getState());
});
var b = store.subscribe(function () {
...
//# sourceMappingURL=/my-redux.e31bb0bc.js.map